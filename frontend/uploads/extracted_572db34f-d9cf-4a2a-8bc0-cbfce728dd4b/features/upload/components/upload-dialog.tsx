    ...
    const interval = setInterval(() => {
      ...
      if (progress >= 100) {
        ...
        toast({
          ...
          description: "Your ZIP file has been uploaded and processed",
        })
      }
    }, 200)
  }
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>Upload a ZIP file containing your legal documents for categorization</DialogDescription>
        </DialogHeader>
