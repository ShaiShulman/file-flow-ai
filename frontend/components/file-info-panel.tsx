    ...
    <div className="h-full flex flex-col overflow-hidden">
      ...
      <Tabs defaultValue="metadata" className="flex-1 flex flex-col overflow-hidden">
        <TabsList className="grid w-full grid-cols-2 h-8 shrink-0 bg-transparent rounded-none border-b border-stone-200 p-0">
          <TabsTrigger value="metadata" className="text-xs gap-1 rounded-none shadow-none bg-transparent data-[state=active]:shadow-none data-[state=active]:bg-transparent data-[state=active]:border-b-2 data-[state=active]:border-stone-900 pb-2">
            Metadata
          </TabsTrigger>
